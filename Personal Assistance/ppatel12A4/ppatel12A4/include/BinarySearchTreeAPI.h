...
typedef struct information{
	...
	double userrating;
	double systemrating;
	double learningrating;
	int used;

} Information;

Information *createInfoNode(char *word, char *line, double userrating, double systemrating, double learningrating, int used);

//TreeNode *search(TreeNode *root, TreeDataPtr data, CompareFunc compare);

TreeNode *insert(TreeNode *root, TreeDataPtr data, CompareFunc compare);

TreeNode *delete(TreeNode *root, TreeDataPtr data, CompareFunc compare);
